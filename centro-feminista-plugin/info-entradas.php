...
function build_publicaciones_container($posts, $sectionName) {
 ...
 function build_recursos_container($posts) {
...
function get_noticias_without_tag($atts) {
    ...
    build_noticias_container($posts, $atts["page-name"]);
}
...
function get_otros_recursos_novedades($atts) {
    ...
    $posts = get_posts($args);
    build_recursos_container($posts, 'novedades');
}
